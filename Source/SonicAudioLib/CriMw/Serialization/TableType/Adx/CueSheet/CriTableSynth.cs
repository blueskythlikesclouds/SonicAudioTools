...
namespace SonicAudioLib.CriMw.Serialization.TableType.Adx.CueSheet
{
    ...
    public class CriTableSynth
    {
        ...
        private string _synname;
        private EnumSynthType _syntype;
        private EnumSynthType _cmplxtype;
        private string _lnkname;
        private string _issetname;
        private short _volume;
        private short _pitch;
        private uint _dlytim = 0;
        private byte _s_cntrl = 0;
        private ushort _eg_dly;
        private ushort _eg_atk;
        private ushort _eg_hld = 0;
        private ushort _eg_dcy = 0;
        private ushort _eg_rel;
        ...
        private string _dryoname;
        private string _mtxrtr;
        private ushort _dry0;
        private ushort _dry1;
        ...
        private string _wcnct0;
        private string _wcnct1;
        private string _wcnct2;
        private string _wcnct3;
        private string _wcnct4;
        private string _wcnct5;
        private string _wcnct6;
        private string _wcnct7;
        private string _vl_gname;
        private byte _vl_type = 0;
        private byte _vl_prio = 0;
        private ushort _vl_phtime = 0;
        private sbyte _vl_pcdlt = 0;
        private short _p3d_vo;
        private short _p3d_vg = 1000;
        private short _p3d_ao = 0;
        private short _p3d_ag = 1000;
        private short _p3d_ido;
